...
_Total: 387 commands | Prefix: ${PREFIX}_
_Powered by *Handsome Tech Zimbabwe* 🇿🇼_`
...
async function motivation({ sock, msg, jid }) {
  const msgs = [
    ...
    'In Zimbabwe we say: *Chero zvaoma, usaramba!* Never give up! 🇿🇼'
  ]
...
async function help({ sock, msg, jid }) {
  await sock.sendMessage(jid, { text: `📚 Type *.menu* to see all 387 commands!` }, { quoted: msg })
}
...
module.exports = {
  menu, ping, uptime, info, alive, joke, fact, quote,
